...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //6.1 Create a query to fetch the Employee with the higest salary and print all his details
            ...
            //6.2 Create a query to fetch the Employee with the higest salary and print all his details
            Query query7 = em.createQuery("Select e FROM Employee e WHERE e.salary = (Select MAX(e.salary) FROM Employee e)");
            query7.setMaxResults(1);
            Employee result7 =(Employee)query7.getSingleResult();
            System.out.println("ID: " + result7.getId() + " - Firstname: " + result7.getFirstName() + " - Lastname: " + result7.getLastName() + " - Salery: " + result7.getSalary());
